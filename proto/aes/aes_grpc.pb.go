...
//
// AES Service definition
type AesClient interface {
	// Perform encryption on received message and returns information about it
...
func (c *aesClient) ShowEncryption(ctx context.Context, in *PlainTextMessage, opts ...grpc.CallOption) (*ReturnEncryptionInfo, error) {
	...
	err := c.cc.Invoke(ctx, Aes_ShowEncryption_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
